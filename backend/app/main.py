...
from app.routes import customers, invoices, acknowledgment, testimonials, line_items, public
...
app.add_middleware(
    CORSMiddleware,
    # allow_origins=["https://192.168.1.187:8000","https://192.168.1.187:3000", "https://invoice.zuperhandy.com", "https://api.invoice.zuperhandy.com"],
    allow_origins=["*"],
